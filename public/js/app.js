...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-40cffcee", module.exports)
  } else {
    hotAPI.update("_v-40cffcee", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _Session = require('./Session.vue');
...
new _vue2.default({
	...
	filters: {
		sessionsFilter: function sessionsFilter(sessions, value, keys) {
			var _this2 = this;
			...
			sessions = sessions.filter(function (session) {
				if (_this2.selectedDay) {
					return session.day == _this2.selectedDay;
				}
				return true;
			});
	...
	methods: {
		...
		setSessions: function setSessions() {
			...
			this.sessions.forEach(function (session) {
				...
				var names = session.speaker.name.split(/[\s]/);
