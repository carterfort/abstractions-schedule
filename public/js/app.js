...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-fc789e40", module.exports)
  } else {
    hotAPI.update("_v-fc789e40", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./marked.min.js":11,"vue":6,"vue-hot-reload-api":3,"vueify/lib/insert-css":7}],9:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n.speaker-container {\n  cursor: pointer;\n}\n\n")
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4e210272", module.exports)
  } else {
    hotAPI.update("_v-4e210272", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _Speaker = require('./Speaker.vue');
...
new _vue2.default({
	...
	components: {
		Speaker: _Speaker2.default, Modal: _Modal2.default
	},
	ready: function ready() {
		var _this = this;

		this.$http.get(this.url).then(function (goodResponse) {
	...
	filters: {
		speakersFilter: function speakersFilter(speakers, value, keys) {
			var _this2 = this;
			...
			speakers = speakers.filter(function (speaker) {
				if (_this2.selectedDay) {
					return speaker.speaking_day == _this2.selectedDay;
				}
				return true;
			});
	...
	methods: {
		actualDateForDay: function actualDateForDay(day) {
			switch (day) {
				case "Thursday":
		...
		speakingSlotForDayAndTime: function speakingSlotForDayAndTime(day, time) {
			var slot = this.actualDateForDay(day);
			if (slot) {
				var timeString = (time / 100).toString();
		...
		setSpeakers: function setSpeakers() {
			var _this3 = this;
			...
			this.days.forEach(function (day) {
				day.stages.forEach(function (stage) {
					stage.sessions.forEach(function (session) {
						...
						session.speaker.time_end = _this3.speakingSlotForDayAndTime(day.name, session.time_end);
						session.speaker.time_start = _this3.speakingSlotForDayAndTime(day.name, session.time_start);
						session.speaker.talk = session.talk;
						_this3.speakers.push(session.speaker);
					});
				});
			});
			...
			this.speakers.forEach(function (speaker) {
				...
				var names = speaker.name.split(/[\s]/);
		...
		sortSpeakers: function sortSpeakers() {
			var _this4 = this;
		...
		loadTalk: function loadTalk(talk) {
			console.log(talk);
			this.showModal = true;
...
},{"./Modal.vue":8,"./Speaker.vue":9,"vue":6,"vue-moment":4,"vue-resource":5}],11:[function(require,module,exports){
(function (global){
"use strict";
